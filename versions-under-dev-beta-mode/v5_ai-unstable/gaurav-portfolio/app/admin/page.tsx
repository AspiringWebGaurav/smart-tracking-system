...
import UnifiedTrainingTab from "@/components/admin/UnifiedTrainingTab";
...
export default function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<"visitors" | "appeals" | "ai-assistant" | "training">(
    "visitors"
  );
  ...
  useEffect(() => {
    if (isAuthenticated) {
      ...
      // Training tab doesn't need initial fetch as it's handled internally
    }
